...
|---|---|---|---|
| 1 | 25000 | 4 | `BonusDefensiveStat1`=2, `BonusDefensiveStat2`=2, `BonusDefensiveStat3`=2, `BonusOffensiveStat1`=0.02, `BonusOffensiveStat2`=0.02, `BonusOffensiveStat3`=0.02 |
